...
| P1.1 | Modern SaaS | completed | The raster hero and code-native anatomy board remain intact. The 2026-07-11 correction adds six contextual color roles, seven visual rules with exact runtime values, four dossier usage examples, and distinguishing signals. Build and desktop Browser QA passed with a horizontal color row and no page overflow. |
...
| P1.13 | Web 2.0 Gloss / Frutiger Aero | planned | |
